...
```
cd world-series-lifespan
mkvirtualenv world-series-lifespan
...
```
* * * * * ubuntu bash /home/ubuntu/apps/world_series_lifespan/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|world-series-lifespan|tweet|`location`||
|world-series-lifespan|facebook|`location`||
|world-series-lifespan|email|`location`||
|world-series-lifespan|new-comment||
|world-series-lifespan|open-share-discuss||
|world-series-lifespan|close-share-discuss||
|world-series-lifespan|summary-copied||
|world-series-lifespan|featured-tweet-action|`action`|
|world-series-lifespan|featured-facebook-action|`action`|
